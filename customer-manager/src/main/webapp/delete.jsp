...
<div class="col-5 table-container">
  <form method="post">
    <table class="col-12">
      <caption>
        <h2 style="color: red">Are you sure you want to delete this person?</h2>
      ...
      <tr>
        ...
        <td>
          <input type="text" readonly name="name" value="${customer.getName()}" placeholder="Name">
        </td>
      </tr>
      <tr>
        <td>
        ...
        <td>
          <input type="text" readonly name="email" value="${customer.getEmail()}" placeholder="Email">
        </td>
      </tr>
      <tr>
        <td>
        ...
        <td>
          <input readonly name="address" value="${customer.getAddress()}" id="address-input" cols="30" rows="3" placeholder="Adress">
        </td>
      </tr>
      </tbody>
    </table>
