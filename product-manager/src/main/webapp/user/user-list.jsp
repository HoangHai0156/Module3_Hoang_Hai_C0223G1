...
<head>
    ...
    <style>
        * {
        ...
        .data-container h2, .data-container h4, .add-button input[type=button], .data-container p {
            margin-bottom: 20px;
        }
        ...
        .add-button input[type=button], input[value="Search"] {
...
<div class="data-container col-7">
    ...
    <table class="data-table">
        ...
        <c:forEach var="user" items="${users}">
            <c:if test="${user.getDeleteAt() == null}">
                <tr>
                    <td>
                        <a href="?action=view&id=${product.getId()}">${user.getFullName()}</a>
                    </td>
                    <td>${user.getAddress()}</td>
                    <td>${user.getDob()}</td>
                    <td>${user.getRole()}</td>
                    <td>
                        <a href="?action=edit&id=${user.getId()}">
