  ...
  <form method="post">
    <table class="col-12">
      ...
      <tr>
        ...
        <td>
          <input readonly value="${requestScope.user.getFullName()}" type="text" name="fullName" placeholder="Full Name">
      ...
      <tr>
        ...
        <td>
          <input readonly value="${requestScope.user.getAddress()}" type="text" name="address" placeholder="Address">
      ...
      <tr>
        ...
        <td>
          <input readonly value="${requestScope.user.getDob()}" type="text" name="dob" placeholder="DOB">
